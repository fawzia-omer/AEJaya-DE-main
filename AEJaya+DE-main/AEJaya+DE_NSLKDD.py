...
def main():
    ...
    train_data_selected.to_csv('NSLKDD_selected_features_train.csv', index=False)

    test_data_selected = pd.DataFrame(X_test_selected, columns=selected_features)
    test_data_selected['label'] = y_test
    test_data_selected.to_csv('NSLKDD_selected_features_test.csv', index=False)

    print("\nFeature Selection Results:")
    print(f"Number of selected features: {sum(best_features)}")
    print(f"Selected features saved to 'selected_features.txt'")
    print("Dataset with selected features saved to 'NSLKDD__selected_features_train.csv' and 'NSLKDD_selected_features_test.csv'")
